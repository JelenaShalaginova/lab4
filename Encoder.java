...
The application should then encode the word and output the encoded word by reversing 
the word and replacing all of the vowels with numbers as
follows: 
	...
	public static void main(String[] args) {
		...
		for(int i = len - 1; i >= 0; i-=1) {
			...
			if(l == 'a' || l == 'A') {
				...
				//if the letter is not vowels then add the actual letter to the encoded word
				sb.append(l);
			}
		}//end for
